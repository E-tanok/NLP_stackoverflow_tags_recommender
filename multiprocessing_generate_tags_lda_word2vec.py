...
print("OK")
from tailored_functions import generate_tags_lda_word2vec, generate_tags_in_list_lda_word2vec, find_similar_neighbors
print("OK")
...
w2v_word_sim_matrix = execution_params['w2v_word_sim_matrix']
w2v_tag_sim_matrix = execution_params['w2v_tag_sim_matrix']
w2v_pure_tag_sim_matrix = execution_params['w2v_pure_tag_sim_matrix']
...
if __name__ == '__main__':
    ...
    with multiprocessing.Pool(N_PROCS) as pool:
        ...
        TASKS = [(corpus, lda_word_sim_matrix, lda_tag_sim_matrix,\
        w2v_word_sim_matrix,w2v_tag_sim_matrix,w2v_pure_tag_sim_matrix,\
        existing_tags, NEIGHBORS, tag_list, QUANTILE_THRESHOLD) \
        for corpus,tag_list in zip(L_sub_lists_of_corpus,L_sub_lists_of_tags)]

        print("TASK ready")
        results = [pool.apply_async(generate_tags_in_list_lda_word2vec, t) for t in TASKS]
        print("results ready")
