...
from functions import filter_list_of_list_values
...
if __name__ == '__main__':
    ...
    with multiprocessing.Pool(N_PROCS) as pool:
        ...
        TASKS = [(sub_list, stopwords) for sub_list in L_sub_lists]
        print("TASK ready")
    ...
    pickle.dump(final_List,open(temp_files_path+"tokenized_text_without_stopwords.p", "wb"))
